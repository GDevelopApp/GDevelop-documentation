...
|<img src="https://resources.gdevelop-app.com/assets/Icons/flash-outline.svg" class="extension-icon"></img>|**Flash (blink)**|Make objects flash (alternately visible and invisible) for a period of time.|[Read more...](https://wiki.gdevelop.io/gdevelop5/extensions/flash)|
