...
!!! tip
    ...
    You can also search for and install extensions directly while adding an action or condition to an event: when looking for an action or condition, choose *Search for new actions/conditions in extensions* to browse and install extensions without leaving the events sheet.
