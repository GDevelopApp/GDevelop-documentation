...
**Authors and contributors** to this experimental extension: [krunkster](https://gd.games/krunkster), [Silver-Streak](https://gd.games/Silver-Streak), [Jurfix](https://gd.games/Jurfix).
...
**Play music by name**  
Play a music file by name or string expression.   
...
??? quote "See parameters & details"
    ...
    > Technical note: this action internal type (in GDevelop JSON) is `AudioByName::PlayMusicByName`.
...
**Play sound by name**  
Play a sound file by name or string expression.   
...
??? quote "See parameters & details"
    ...
    > Technical note: this action internal type (in GDevelop JSON) is `AudioByName::PlaySoundByName`.
