...
Poki Games SDK: display ads and manage game lifecycle for Poki hosting.

**Authors and contributors** to this extension: [alex_](https://gd.games/alex_).
...
| `PokiGamesSDKHtml::URLParam(string)` | Read a URL parameter from Poki URL or the current URL. ||
