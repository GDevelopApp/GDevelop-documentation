...
The **Scale on X axis** and **Scale on Y axis** properties control how strong the displacement is on each axis (in pixels). Setting one of them to 0 restricts the warping to a single direction.
