...
!!! tip
    ...
    Linked object relationships are automatically **saved and restored** by the [Save State extension](/gdevelop5/all-features/save-state/). Objects marked as "Do not save" do not have their links persisted.
