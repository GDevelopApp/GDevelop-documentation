...
!!! note
    ...
    Tile maps can be used as obstacles: add the "Obstacle for Pathfinding" behavior to a [Tilemap](/gdevelop5/objects/simple_tilemap) or [Tilemap collision mask](/gdevelop5/objects/tilemap) object and only the cells containing a tile hitbox will block the path.
