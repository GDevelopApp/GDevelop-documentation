...
!!! tip
    ...
    Each custom object can have its own icon, separate from the extension icon. To set it, open the object configuration and use the **Icon URL** field (requires the extension to have an icon set first).
