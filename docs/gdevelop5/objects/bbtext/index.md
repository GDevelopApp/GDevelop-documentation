...
[![](bbtext-example.jpg){ width="320" }](https://editor.gdevelop.io/?create-from-example=bbtext-object-demo)

[Open example in GDevelop](https://editor.gdevelop.io/?create-from-example=bbtext-object-demo){ .md-button .md-button--primary }
