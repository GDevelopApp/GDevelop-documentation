...
When a texture is used, the light follows the object's angle, so you can rotate a textured light to point it in any direction (for example, to make a flashlight aim where the player is facing).
