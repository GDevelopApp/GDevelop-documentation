...
In the 2D editor, press **F** to move the view to the currently selected instances. This is handy to quickly get back to your objects after panning away in a large scene.
