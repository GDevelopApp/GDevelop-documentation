...
The panel also has a visibility toggle to make the selected instance **hidden when the scene starts**. The instance stays visible in the editor, but won't be shown when the game runs until you make it visible again with an action.
