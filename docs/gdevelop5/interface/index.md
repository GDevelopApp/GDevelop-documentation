...
To discard all unsaved changes and revert to the last saved version, use **Reload Project** from the command palette or the File menu. This reloads the project from disk or the cloud and cannot be undone.
