...
By default, use Ctrl+P (or Ctrl+K) to open the command palette. You can change the primary shortcut to your liking—see the **Editing Shortcuts** section on this page.
